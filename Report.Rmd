...
author: "Zhe Zhao (433707), Yufei Sun (426201)"
date: '2022-08-15'
output:
  html_document:
    toc: yes
...
A questionnaire was made using Google form, and 39 samples were collected. We use these samples to evaluate and report on customer profiling, areas of satisfaction, and demographics to target for potential growth opportunities. The questionnaire included 20 questions,
the first four questions were personal information about the participants, and the remaining questions were about our topic: *Starbucks*.
